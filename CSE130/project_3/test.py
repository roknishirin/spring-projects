...
NUMBER_OF_TRIALS = 50        # default 100
...
for trial in range(1, NUMBER_OF_TRIALS+1):
    ...
    os.system('cat example6.c >> log_file')
    ...
    for loop in range(1, LOOPS_PER_TRIAL+1):
        ...
        os.system('valgrind --leak-check=full --log-file=valgrind_out ./example6 > output_file')
