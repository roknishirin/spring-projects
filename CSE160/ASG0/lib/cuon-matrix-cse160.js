...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        let v = other1.elements;
        let vv = other2.elements;
    ...
    static cross(other1, other2) {
        ...
        // math
        v3.elements[0] = (v[1] * vv[2]) - (v[2] * vv[1]);
        v3.elements[1] = (v[2] * vv[0]) - (v[0] * vv[2]);
        v3.elements[2] = (v[0] * vv[1]) - (v[1] * vv[0]);
